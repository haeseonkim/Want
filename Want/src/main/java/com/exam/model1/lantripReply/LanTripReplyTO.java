...
public class LanTripReplyTO {
	private String no;
	private String bno;	// 댓글이 속한 게시글 번호 (받아와야 하는 )
	private String grp;	// 댓글 그룹 번호 (모댓글과 거기에 속한 대댓글은 같은 grp를 가짐)
	private String grps;	// 그룹 내 댓글 순서 (오래된글 ~ 최신글  오름차순)
	private int grpl;	// 그룹내 댓글 깊이(댓글인지 대댓글인지)
	private String writer;
	private String content;
	private String wdate;;
	private String wgap;	// wdate과 현재시간의 차이를 계산후 받아오기위
