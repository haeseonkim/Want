...
public class AccomListTO {
	...
	private ArrayList<AccomTO> accomLists;
	...
	public ArrayList<AccomTO> getAccomLists() {
		return accomLists;
	}

	public void setAccomLists(ArrayList<AccomTO> accomLists) {
		this.accomLists = accomLists;
	}
}
