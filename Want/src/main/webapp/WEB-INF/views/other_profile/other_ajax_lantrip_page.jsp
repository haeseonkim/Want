	...
	<div class="col-3 card-inner">
		<div class="thumb">
			<div class="card-img" type="button" idx="${tmp.no }"
				...
				<div class="video-box">
					<video src="./upload/lanTrip/${ tmp.video }" class="card-img-top img-wrapper list-video" muted></video>
				</div>
			</div>
			<!-- 마우스 오버시 보여지는 부분 --> 
			<div class="links" style="text-align:center;" type="button" idx="${ tmp.no }"
				...
				</svg>&nbsp;<span id="heart${tmp.no }">${ tmp.heart }</span> 
				...
				</svg>&nbsp;<span id="reply${tmp.no }">${ tmp.reply }</span> 
			</div>
		</div>
	</div>
				...
				<div class="modal-body">
					...
					<section class="modal-section-media">
						<div class="container" id="m_media">
							<video src="./upload/lanTrip/${ tmp.video }" class="w-100" controls></video>
						</div>
					</section>
