...
<body>
	...
	<script>
		...
		// 게시물 리스트를 처음으로 가져오는 함수
		const GetFirstList = function(currentPage){
			console.log("GetFirstList 호출됨");
			
			// 무한 스크롤
			$.ajax({
				url : "other_ajax_lantrip_page.do",
				method : "GET",
				...
				success:function(data){
					...
					$(".heart-click").click(function() {
						...
						if($(this).children('svg').attr('class') == "bi bi-suit-heart"){
							...
							$.ajax({
								url : 'other_'+currentTab+'_saveHeart.do',
								type : 'get',
								data : {
									no : no,
								},
						...
						// 꽉찬 하트를 눌렀을 때
							...
							$.ajax({
								url : 'other_'+currentTab+'_removeHeart.do',
								type : 'get',
								data : {
									no : no,
								},
