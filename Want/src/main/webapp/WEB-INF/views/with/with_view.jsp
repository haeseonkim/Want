...
<body>
	...
	<section id="info" class="container" style="margin-top:100px;">
		<table class="table table-hover" id='board_list'>
			<thead>
			<div id="with_header" class="align-middle">
				<br />
				<div id="header-title" class="fs-1 d-block"><b>동행구하기</b></div>
				<span id="header-sub" class="fs-6">함께 여행할 동행을 구해보세요!</span>
			</div>
				<tr>
	...
	<section class="container" style="margin-top:10px;">
	    ...
	    <div id="btn_buttons">
			<span>
				...
				onclick="location.href='./with_list.do'"> 목록 </button>
    			...
    			<div class="modal-content" >
    				<br />
      				...
      				<div class="modal-footer">
        				...
        				<button type="button" class="btn btn--blue-2" onclick="location.href='./with_delete_ok.do?no=<%=request.getParameter("no")%>'">삭제</button>
      				</div>
    			</div>
  			...
  			<div class="modal-dialog modal-sm">
    			...
    			<div class="modal-content">
      			...
      			<div style="height:60px;">&nbsp;&nbsp;정말 수정하시겠습니까?</div>
      				<div class="modal-footer">
        				<button type="button" class="btn btn--silver" data-bs-dismiss="modal" >취소</button>
        				<button type="button" class="btn btn--blue-2" onclick="location.href='./with_modify.do?no=<%=request.getParameter("no")%>'">수정</button>
      				</div>
    			</div>
