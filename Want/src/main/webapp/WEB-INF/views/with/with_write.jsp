...
<body>
	...
	<jsp:include page="../include/navbar.jsp">
		<jsp:param value="with_write" name="thisPage" />
	</jsp:include>
		...
		<div class="wrapper wrapper--w900">
			<div class="card card-6">
				...
				<div class="card-heading">
					<h2 class="title">함께 여행할 동행을 구해보세요!</h2>
				</div>
				<div class="card-body">
					<form action="./with_write_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
				...
				<div class="card-footer">
					...
					<c:otherwise>
						<button type="submit" id="submit1" class="btn btn--radius-2 btn--blue-2" onclick="location.href='./with_write.do?cpage=<%=cpage%>'">등록하기</button>
					</c:otherwise>
					</c:choose>
				</div>
			</div>
