...
<!-- CSS File -->
<link href="./resources/css/shopping_write.css?asdfa" rel="stylesheet">
		...
		<div class="wrapper wrapper--w900">
			<div class="card card-6">
				...
				<div class="card-heading">
					<h2 class="title">쇼핑 정보 등록</h2>
				</div>
				<div class="card-body">
					<form action="./shopping_write_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group js-input-file">
									...
									<span class="input-file__info" id="picture_name">No file chosen</span>
								</div>
								<div class="label--desc">쇼핑 사진을 업로드하세요.</div>
							</div>
						</div>
				...
				<div class="card-footer">
					<button class="btn btn--radius-2 btn--blue-2" type="submit" id="submit1" >등록하기</button>
				</div>
			</div>
		</div>
	</div>
