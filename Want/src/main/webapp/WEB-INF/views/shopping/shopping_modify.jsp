...
<!-- CSS File -->
<link href="./resources/css/shopping_modify.css?asdfa" rel="stylesheet">
...
<body>
	...
	<jsp:include page="../include/navbar.jsp">
		<jsp:param value="shopping_modify" name="thisPage" />
	</jsp:include>
