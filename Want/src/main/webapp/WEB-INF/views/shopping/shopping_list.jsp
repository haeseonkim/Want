...
for (ShoppingTO to : list) {
	...
	sbHtml.append(
	" 		<a href='./shopping_view.do?no=" + to.getNo() + "&location=" + location + "' class='text-dark'>");
	sbHtml.append(
	" 		<img src='./upload/shopping/" + to.getPicture() + "' alt='' class='img-fluid card-img-top'>");
	sbHtml.append(" 		<div class='p-4'>");
	sbHtml.append(" 			<h5><a href='./shopping_view.do?no=" + to.getNo() + "&location=" + location
