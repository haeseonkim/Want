...
<body>
	...
	<div class="login-form" data-aos="fade-up">
		...
		<form action="loginForm_ok.do" method="post" class="form-horizontal" name="lfrm">
			...
			<div class="form-group row">
				...
				<div class="col-8">
					<input type="text" class="form-control" name="id"
						placeholder="ID 입력..." required="required">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-8">
					<input type="password" class="form-control" name="password"
						placeholder="Password 입력..." required="required">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-8 offset-2">
					<button type="submit1" class="btn btn-primary btn-lg">로그인</button>
				</div>
			</div>
		...
		<div class="text-center">
			비밀번호가 기억나지 않습니까? <a href="#">비밀번호 찾기</a>
		</div>
		<div class="text-center">
			아직 회원이 아니십니까? <a href="./signupForm.do">회원가입</a>
		</div>
	</div>
</body>
</html>
