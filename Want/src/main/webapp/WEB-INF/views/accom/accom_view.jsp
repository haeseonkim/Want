...
<!-- CSS File -->
<link href="./resources/css/accom_view.css?wq" rel="stylesheet">
		...
		<div class="view3">
			...
			<tr>
				<td class="coment_re" width="20%">
					...
					<div class="btn_dm">
						<input type="button" id="submit_delete" value="삭제" class="btn btn-success" onclick="location.href='./accom_list.do?cpage=<%=cpage %>&no=<%=no %>" />
						<input type="button" id="submit_modify" value="수정" class="btn btn-success" onclick="location.href='./accom_list.do?cpage=<%=cpage %>&no=<%=no %>" />
					</div>
				</td>
			</tr>
			</table>
