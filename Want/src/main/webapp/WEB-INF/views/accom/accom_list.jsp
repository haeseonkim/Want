...
<%
	...
	for ( AccomTO to : listTO.getAccomLists()) {
		...
		sbHtml.append( " 		<a href='./accom_view.do?cpage="+ cpage +"&no="+to.getNo()+"&location="+ location +"' class='text-dark'>" );
		sbHtml.append( " 		<img src='./upload/accom/" + to.getPicture() + "' alt='' class='img-fluid card-img-top'>" );
		sbHtml.append( " 		<div class='p-4'>" );
		sbHtml.append( " 			<h5><a href='./accom_view.do?cpage="+ cpage +"&no="+to.getNo()+"&location="+ location +"' class='text-dark'>" + to.getSubject() + "</a></h5>" );
...
<!-- CSS File -->
<link href="./resources/css/accom_list.css?qasd" rel="stylesheet">
				...
				<div class="col-lg-12 mx-auto">
					<div class="text-white p-5 shadow-sm rounded banner">
						...
						<c:choose>
							...
							<c:otherwise>
								<button type="button" class="btn btn-primary"
									onclick="location.href='./accom_write.do?location=<%=location%>&cpage=<%=cpage%>'">글쓰기</button>
							</c:otherwise>
						</c:choose>
						</div>
					</div>
