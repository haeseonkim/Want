...
<body>
	...
	<jsp:include page="../include/navbar.jsp">
		<jsp:param value="accom_write" name="thisPage" />
	</jsp:include>
...
<div class="contents1"> 
	...
	<form action="./accom_write_ok.do" method="post" name="s_wfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			...
			<div class="btn_area">
				<div class="align_left">			
					<input type="button" value="목록" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./accom_list.do?cityName=<%=cityName %>'" />
				</div>
