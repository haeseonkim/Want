		...
		<div class="thumb">
			<div class="card-img" type="button" idx="${ tmp.no }"
				...
				<div class="links" style="text-align:center;" type="button" idx="${ tmp.no }"
					...
					</svg> <span class="span_heart${ tmp.no }" >${ tmp.heart } </span> 
					...
					</svg> <span class="span_reply${ tmp.no }" >${ tmp.reply }</span> 
				</div>
			</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="location.href='./accom_modify.do?no=${tmp.no}'">네</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
						data-bs-dismiss="modal">아니요</button>
					<button type="button" class="btn btn-primary"
						onclick="location.href='javascript:BoardDelete(${tmp.no}, 4 )'">네</button>
				</div>
			</div>
		</div>
	</div>
